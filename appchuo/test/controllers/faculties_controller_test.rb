...
class FacultiesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create faculty" do
    assert_difference('Faculty.count') do
      post faculties_url, params: { faculty: { address: @faculty.address, department: @faculty.department, hobby: @faculty.hobby } }
    end
  ...
  test "should update faculty" do
    patch faculty_url(@faculty), params: { faculty: { address: @faculty.address, department: @faculty.department, hobby: @faculty.hobby } }
